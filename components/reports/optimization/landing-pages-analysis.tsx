...
const MOCK_DATA = {
  landingPages: [
    { name: 'Weight Loss LP 1', visits: 12500, leads: 625, conversionRate: '5.0%', revenue: 15625, trend: '+12.5%' },
    { name: 'Crypto Trading LP', visits: 8900, leads: 356, conversionRate: '4.0%', revenue: 8900, trend: '-3.2%' },
    { name: 'Fitness Program LP', visits: 7500, leads: 300, conversionRate: '4.0%', revenue: 7500, trend: '+8.7%' },
    { name: 'Investment Course LP', visits: 6200, leads: 248, conversionRate: '4.0%', revenue: 6200, trend: '+1.5%' },
  ],
  performanceData: [
    { name: 'Mon', visits: 1500, leads: 75 },
    { name: 'Tue', visits: 1200, leads: 48 },
    { name: 'Wed', visits: 1800, leads: 90 },
    { name: 'Thu', visits: 1600, leads: 80 },
    { name: 'Fri', visits: 1400, leads: 70 },
    { name: 'Sat', visits: 1100, leads: 55 },
    { name: 'Sun', visits: 1300, leads: 65 },
  ]
};
          ...
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={MOCK_DATA.performanceData}>
                ...
                <Tooltip />
                <Legend />
                <Bar yAxisId="left" dataKey="visits" fill="hsl(var(--primary))" name="Visits" />
