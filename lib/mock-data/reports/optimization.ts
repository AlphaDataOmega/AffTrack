export const optimizationData = {
  landingPages: {
    performance: [
      { name: 'Mon', visits: 1500, conversions: 75 },
      { name: 'Tue', visits: 1200, conversions: 48 },
      { name: 'Wed', visits: 1800, conversions: 90 },
      { name: 'Thu', visits: 1600, conversions: 80 },
      { name: 'Fri', visits: 1400, conversions: 70 },
      { name: 'Sat', visits: 1100, conversions: 55 },
      { name: 'Sun', visits: 1300, conversions: 65 }
    ],
    overview: [
      { name: 'Weight Loss LP 1', visits: 12500, conversions: 625, rate: '5.0%', revenue: 15625, trend: '+12.5%' },
      { name: 'Crypto Trading LP', visits: 8900, conversions: 356, rate: '4.0%', revenue: 8900, trend: '-3.2%' },
      { name: 'Fitness Program LP', visits: 7500, conversions: 300, rate: '4.0%', revenue: 7500, trend: '+8.7%' },
      { name: 'Investment Course LP', visits: 6200, conversions: 248, rate: '4.0%', revenue: 6200, trend: '+1.5%' }
    ]
  },
  paths: {
    overview: [
      { path: '/weight-loss/keto', visits: 8500, bounceRate: '35%', avgTime: '2:45', conversions: 425, trend: '+12.5%' },
      { path: '/crypto/bitcoin', visits: 6200, bounceRate: '42%', avgTime: '1:55', conversions: 248, trend: '-3.2%' },
      { path: '/fitness/hiit', visits: 5100, bounceRate: '38%', avgTime: '2:15', conversions: 204, trend: '+8.7%' },
      { path: '/invest/stocks', visits: 4200, bounceRate: '40%', avgTime: '2:05', conversions: 168, trend: '+1.5%' }
    ],
    trends: [
